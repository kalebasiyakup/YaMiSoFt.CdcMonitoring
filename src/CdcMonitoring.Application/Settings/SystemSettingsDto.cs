...
public record SystemSettingsDto(
    ...
    bool SchemaCatalogEnabled,
    int SchemaCatalogIntervalSeconds,
    int SchemaCatalogMaxDegreeOfParallelism,
    int SchemaCatalogTimeoutSeconds,
    List<string> SchemaCatalogExcludedSchemas,
    int SchemaChangeRetentionDays,
    int SchemaScanRetentionDays,
    bool EmailEnabled,
    string SmtpHost,
    int SmtpPort,
